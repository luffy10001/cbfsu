            ...
            <form action="{{route('insurer.update')}}" method="POST">
                ...
                <div class="row relative">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Name" id="name" name="name" value="{{$insurer->name}}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="email" class="form-label">Email*</label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{$insurer->email}}"/>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="phone" class="form-label">Phone*</label>
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" value="{{$insurer->phone}}"/>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select  placeholder="Select Underwriter" class="form-select select2selector" id="Underwriter_id" name="underwriter_id">
                            ...
                            @foreach($underwriters as $obj)
                                <option value="{{$obj->id}}" @selected($obj->id == $insurer->underwriter_id)> {{ $obj->name }} </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" placeholder="Address" rows="3">{{$insurer->address}}</textarea>
                    </div>
                </div>
