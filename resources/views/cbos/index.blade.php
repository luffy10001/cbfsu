    ...
    <x-slot name="header">
        <x-table-header-component>
            ...
            <x-slot name="buttons">
                ...
                <button class="btn btn-primary float-end modal_open" url="{{route('cbo.create')}}" size="md"> Add New CBO </button>
                <button class="btn btn-primary float-end modal_open mr-1" url="{{route('cbo.create')}}" size="md"> CBO Targets </button>
