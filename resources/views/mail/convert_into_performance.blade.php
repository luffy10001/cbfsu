...
<head>
    ...
    <title>Document Conversion and Approval</title>
    <style>
        body {
...
<div class="email-container">
    <div class="header">
        <h1>Document Conversion and Approval</h1>
    </div>
    <div class="content">
        {{--        <p>Dear <strong>{{ $data['admin_name'] }}</strong>,</p>--}}
        <p>Dear <strong>Admin</strong>,</p>

        <p>We would like to inform you that the following customer has converted documents into performance. Please find the details below:</p>
        ...
        <p>Please review this and take any necessary action. If you have any questions, feel free to contact the customer directly.</p>
