        ...
        <div class="login-input">
            ...
            <div class="login-input-field-container">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <label style="color: #555555;" class="form-label">Email Address</label>
                    <div class="mb-3 position-relative">
                        <input name="email" type="email" class="form-control login-input-field" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                    ...
                    <label style="color: #555555;" class="form-label">Password</label>
                    <div class="mb-3 mt-2 position-relative">
                        <input name="password" type="password" class="form-control login-input-field" placeholder="Password" aria-label="Password" autocomplete="current-password">
                        <span class="login-svg-background position-absolute">
                    ...
                    <div class="w-100 d-flex justify-content-end align-items-end mt-4">
                        <a href="{{ route('password.request') }}" class="forgetPasswordTag forgot-password">Forgot Password?</a>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <button type="submit" class="formRedButton mt-4">Login Now</button>
                    </div>
                </form>
            </div>
        </div>
