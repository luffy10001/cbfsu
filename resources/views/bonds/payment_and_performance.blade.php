...
<body>
    <p style="font-size:12px; text-align: right; margin-top: 3px;">Bond No. AJ1265868 </p>
    ...
    <div class="row">
        <div class="left-div" style="font-family: Arial, sans-serif; text-align: center">
               ...
               <strong style="font-size:20px; float: left;  !important;"> <i>Performance Bond </i></strong><br>
            <br>
        </div>
    </div>
        ...
        <tr>
            ...
            <td style="vertical-align: top; width: 30%; text-align: left;">
                <p style="font-size:10px;">
                    This document has important legal consequences. Consultation with an attorney is encourage with respect to its completion or modification
                </p>
                <p style="font-size:10px; margin-top: 1px">
                    Any singular references to Contractor, Surety, Owner or other party shall be considered plural where applicable
                </p>
            </td>
        </tr>
    </table>
    <div class="pb-heading" style="padding-left: 2px"> <strong> CONSTRUCTION CONTRACT:</strong> </div>
    <div class="pb-heading-text" style="padding-left: 2px"> <strong> Date: </strong> 8/1/2021e</div>
    <div class="pb-heading-text" style="padding-left: 2px"> <strong> Amount: </strong> $23,645,000.00</div>
    <div class="pb-heading-text" style="padding-left: 2px"> <strong> Description: </strong></div>

    <table style="width: 100% ; margin-top: 10px">
        <tr>
            <td style="vertical-align: top; width: 100%;">
                <div class="pb-heading"><strong>Project Description as entered by the customer (Principal):</strong> </div>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 100%; margin-top: 3px;">
        <tr>
            <td style="vertical-align: top; width: 60%; text-align: left;">
                ...
                <div> <strong style="font-size: 12px">Date</strong>: 8/1/2021</div>
                <div class="pb-heading-text"> <i> (Not earlier than Construction Contract Date) </i> </div>
                <div > <strong style="font-size: 12px"> Amount</strong>: $23,645,000.00</div>
                <div > <strong style="font-size: 12px">Modification to this Bond: </strong> <input type="checkbox">None <input type="checkbox">See Section 16 </div>
            </td>
            <td style="vertical-align: top; width: 40%; text-align: left;">
                <div style="width: 120px; height: 120px; padding-left: 110px">
                    <img src="{!! public_path('/images/bid_bond/perf_green_stamp.png') !!}" style="max-width: 120%; max-height: 120%; object-fit: contain; display: block;">
                </div>
            </td>
    ...
    <table style="width: 100%; margin-top: 3px;">
        <tr>
            <td style="vertical-align: top; width: 50%;">
                ...
                <div class="pb-heading-text"> <strong>Company: </strong> <i style="padding-left: 50px">(Corporate Seal)</i> </div>
{{--                <div style="margin-top: 5px;"> <strong>Surety Name: </strong> {!! $bond_data->customer->authority->surerty->name!!}</div>--}}
                <div class="pb-heading-text" style="margin-top: 58px !important;"> <strong>Signature: </strong> <span class="line-underline" style=" width: 70%; display: inline-block;">&nbsp;</span> </div>
    ...
    <div style="font-family: Arial, sans-serif; text-align: left; margin-top: 32px">
        <i style="font-size:11px; margin-top: 3px;">(Any additional signatures appear on the last page of this Performance Bond ) </i><br>
        <i style="font-size:11px; margin-top: 3px;">(FOR INFORMATION ONLY -- Name, address and telephone ) </i>
    </div>
    ...
    <table style="width: 100%; margin-top: 10px;">
        <tr>
            <td style="vertical-align: top; width: 50%;">
                ...
                <div class="pb-heading-text" > St. Charles Insurance,</div>
                <div class="pb-heading-text" > 4600 Executive Center Parkway, Suite D</div>
                <div class="pb-heading-text" > St, Peters, MO63376-1671</div>
                <div class="pb-heading-text" > 636-477-0500</div>

            </td>
            <td style="vertical-align: top; width: 50%; text-align: left;">
                <div class="pb-heading-text"> <strong> OWNER'S REPRESENTATIVE:</strong> </div>
                <i style="font-size:11px; margin-top: 3px;">(Architect, Engineer or other party:) </i>
