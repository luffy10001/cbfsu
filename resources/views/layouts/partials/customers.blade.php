@if(isPermission('customer.index'))
    <x-sidebar-dropdown>
        ...
        @endif
        @if(isPermission('project-management.index'))
            <li class="nav-item {!! isCurrentRoute('project-management.index')?'live-active':'' !!}">
                <a class="nav-link" href="{{route('project-management.index')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                         stroke-linejoin="round" class="feather feather-users" aria-hidden="true">
                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
