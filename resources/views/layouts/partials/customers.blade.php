@if(isPermission('customer.index')||isPermission('customer.create')||isPermission('customer.edit'))
    <x-sidebar-dropdown>
        <x-slot name="icon">
        ...
        <x-slot name="activeTab">
            {!! (isCurrentRoute('customer.index')||isCurrentRoute('customer.create')||isCurrentRoute('customer.edit'))?'show':'' !!}
        </x-slot>
        <li class="nav-item {!! isCurrentRoute('customer.index') || isCurrentRoute('customer.create') || isCurrentRoute('customer.edit') ? 'live-active':'' !!}">
