<div class="position-sticky pt-3 sidebar">
    <ul class="nav flex-column">
        @if(isPermission('dashboard.index'))
            <x-sidebar-dropdown href="/" :class="isCurrentRoute('dashboard.index') ? 'live-active' : ''">
                <x-slot name="icon">
                    <svg width="18" height="18" class="mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H11V21ZM13 21H19C20.1 21 21 20.1 21 19V12H13V21ZM21 10V5C21 3.9 20.1 3 19 3H13V10H21Z" fill="white"/>
                    </svg>
                </x-slot>
                <x-slot name="label">
                    Dashboard
...
{{--            <li class="nav-item {!! isCurrentRoute('dashboard.index')?'live-active':'' !!}">--}}
...
{{--            </li>--}}
        ...
        @include('layouts.partials.gf_reporting')
        @include('layouts.partials.m_and_e') <!----  M&E Operations --->
        @include('layouts.partials.psm')
        @include('layouts.partials.finance')
        @include('layouts.partials.programme')
        @if(isPermission('roles.index'))
            @include('layouts.partials.reports')
        @endif
        ...
        @endif
        @if(isPermission('information.index'))
            <li class="nav-item {!! isCurrentRoute('information.index') ? 'live-active':'' !!}">
                <a class="nav-link" href="{{route('information.index')}}">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 8H3V4H21V8ZM21 10H3V14H21V10ZM21 16H3V20H21V16Z" fill="white"/>
                    </svg>
                    Information Hub
                </a>
            </li>
